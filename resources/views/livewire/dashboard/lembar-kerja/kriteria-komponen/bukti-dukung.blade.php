                ...
                <div class="card">
                    ...
                    <div class="card-body" style="padding-bottom: 0">
                        <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-primary" role="tablist">
                            ...
                            <li class="nav-item">
                                <a @click="@if ($this->penilaianDiKriteria) tab = 'penilaian' @endif"
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th rowspan="2" scope="col">Bukti Dukung</th>
                                            <th colspan="3">Status</th>
                                            {{-- <th rowspan="2" scope="col">Dokumen</th> --}}
                                            <th rowspan="2" scope="col">Aksi</th>
                                            @if (Auth::user()->role->jenis == 'admin' || Auth::user()->role->jenis == 'opd')
                                                <th rowspan="2" scope="col">Tracking</th>
                                            @endif
                                        </tr>
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (Auth::user()->role->jenis == 'opd' || Auth::user()->role->jenis == 'admin')
                                                        {{-- OPD selalu punya tombol Unggah/Lihat --}}
                            ...
                            <div class="col-md-10">
                                <div class="tab-content mt-4 mt-md-0">
                                    <div x-show="menu === 'dokumen'" aria-labelledby="v-pills-home-tab">
                                        @if ($this->penilaianDiKriteria)
                                            {{-- Mode Kriteria: Tampilkan semua dokumen dari semua bukti dukung (grouped) --}}
                                                        ...
                                                        @if ($buktiItem->file_bukti_dukung->isNotEmpty())
                                                            @foreach ($buktiItem->file_bukti_dukung as $uploadIndex => $fileRecord)
                                                                @php
                                                                    ...
                                                                    $files = json_decode($fileRecord->link_file, true);
                                                                    if (!is_array($files)) {
                                                                        $files = [];
                                                                    }
                                                                @endphp
