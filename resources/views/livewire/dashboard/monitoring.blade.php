                ...
                @foreach ($this->subKomponenOptions as $sub_komponen)
                    <div wire:key="{{ $sub_komponen->id }}" class="col-xxl-4 col-lg-4"
                        ...
                        <div class="card card-body text-center">
                            ...
                            <a href="{{ route('monitoring.kriteria-komponen', ['sub_komponen_id' => $sub_komponen->id]) }}"
                                            ...
                                            @forelse ($this->komponenOptions as $index => $komponen)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($nilaiTotal > 0)
                                                            <span
                                                                class="fw-semibold">{{ number_format($nilaiTotal, 2) }}%</span>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($this->subKomponenOptions as $index => $subKomponen)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('monitoring.kriteria-komponen', ['sub_komponen_id' => $subKomponen->id]) }}"
